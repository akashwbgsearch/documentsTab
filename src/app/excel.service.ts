...
export class ExcelService {
  ...
  public exportProjectsExcelFile(json: any[], excelFileName: string, tableHeaders: any[]): void {
    ...
    public exportArchivalExcelFile(json: any[], excelFileName: string, tableHeaders: any[]): void {
